                            ...
                            <form id="form_experimental" onsubmit="return submitexperimental();" >
                                ...
                                <table class="form-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>
                                                <label for="cbprintscr">Inspect Source</label>
                                            </th>
                                            <td>
                                                <input type="checkbox" id="disable_f12_key" name="smart_content_disable_f12_key" value="1"<?php checked('1', get_option('smart_content_disable_f12_key')); ?>/><label>(Disable F12)</label>
                                            </td>
                                        </tr>
